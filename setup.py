"""A pipeline that takes as input a set of paired reads and generates an assembly, aligns the reads to a reference and does the variant calling
See also: https://github.com/farhat-lab/megapipe
"""
...
setup(
    ...
    # https://packaging.python.org/en/latest/requirements.ht
    ...
    scripts=["bin/"+s for s in listdir("bin/")]
)
